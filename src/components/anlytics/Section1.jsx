...
const Section1 = () => {
    return (
      <div className=" flex flex-row tablet:justify-around pt-2 my-4 text-xs tablet:text-base font-ligth tablet:font-medium items-start tablet:items-center tablet:w-auto overflow-x-auto ">
        <div className="flex fex-row justify-around min-w-[75vh]">

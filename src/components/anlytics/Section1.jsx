...
const Section1 = () => {
    return (
      <div className=" flex flex-row tablet:justify-around pt-2 my-4 text-xs tablet:text-base font-ligth tablet:font-medium items-start tablet:items-center tablet:w-auto">
